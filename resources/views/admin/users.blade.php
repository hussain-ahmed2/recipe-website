<x-layout>
    ...
    <x-admin-layout title="Users">
        ...
        <div class="mb-8">
            ...
            <form class="flex gap-1" action="/admin/users" method="GET">
            ...
            <tbody>
                @foreach ($users as $user)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <div class="flex items-center">
                                <div class="mr-2">
                                    <img class="w-10 h-10 rounded-full"
                                        src="{{ $user->avatar ? (Str::startsWith($user->avatar, 'http') ? $user->avatar : Vite::asset($user->avatar)) : "https://ui-avatars.com/api/?name=$user->name&background=random&color=fff&size=128" }}"
                                        alt="avatar">
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="py-3 px-6 text-left whitespace-nowrap">{{ $user->is_admin ? "Admin" : "User" }}</td>
                        <td class="py-3 px-6 text-left whitespace-nowrap">
