...
<article class="max-w-96 relative p-5 rounded-3xl bg-gradient-to-b from-white to-cyan-50 flex flex-col gap-8 hover:from-cyan-200 tc">
    ...
    <button class="absolute top-10 right-10">
        <box-icon class="bg-white h-12 w-12 p-2.5 rounded-full" color="{{ round(rand(0, 1)) ? 'red' : 'lightgray' }}"
